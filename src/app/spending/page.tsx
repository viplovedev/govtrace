...
import { SPENDING_ITEMS } from '@/lib/data'
...
export default function SpendingPage() {
  ...
  const totalBudget = SPENDING_ITEMS.reduce((a, b) => a + b.amount, 0)

  return (
    <div>
      <PageTitleBar
        title="Government Spending"
        subtitle={`Hoodi Ward (BBMP) · FY 2024–25 · Total: ${formatCrore(totalBudget)}`}
      />
